...
const settings = {
  ...
  // InkVell's main persistent data store is MongoDB (http://www.mongodb.org/)
  ...
  mongo: {
    url: process.env.OVERLEAF_MONGO_URL || 'mongodb://dockerhost/inkvell',
  },

  // Redis is used in InkVell for high volume queries, like real-time
  ...
  // Where your instance of InkVell can be found publicly. This is used
  ...
  // The name this is used to describe your InkVell Installation
  appName: process.env.OVERLEAF_APP_NAME || 'InkVell',
  ...
  // contact for this installation of InkVell.
  ...
  // If you are running InkVell over https, set this to true to send the
  // cookie with a secure flag (recommended).
  secureCookie: process.env.OVERLEAF_SECURE_COOKIE != null,

  // If you are running InkVell behind a proxy (like Apache, Nginx, etc)
...
// InkVell. The config settings are passed to nodemailer. See the nodemailer
