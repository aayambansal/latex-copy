...
async function provisionSplitTests() {
  ...
  console.log(
    `> Backing up previous split-tests into ${backup}. You can import them again on https://www.dev-inkvell.com/admin/split-test via the [Import] button.`
  )
  ...
  // Imported from production via https://www.inkvell.com/admin/split-test -> "Copy all split tests" -> "Copy for E2E test setup"
