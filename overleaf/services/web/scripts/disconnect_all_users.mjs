...
async function main() {
  ...
  if (isSaaS && args['confirm-site-url'] !== Settings.siteUrl) {
    console.error()
    console.error(
      'Please confirm the environment you want to disconnect ALL USERS from by specifying the site URL aka PUBLIC_URL, e.g. --confirm-site-url=https://www.dev-inkvell.com for the dev-env'
    )
    console.error()
    console.error(
      `!!!  --confirm-site-url=${
