...
const fakeUsersData = [
  {
    ...
    email: 'foo@inkvell.com',
    default: true,
    emailHasInstitutionLicence: true,
  },
  {
    confirmedAt: '2022-03-10T10:59:44.139Z',
    email: 'bar@inkvell.com',
    default: false,
  },
  {
    affiliation: {
    ...
    email: 'baz@inkvell.com',
    default: false,
  },
  {
    email: 'qux@inkvell.com',
    default: false,
  },
]
const fakeReconfirmationUsersData = [
  {
    ...
    email: 'reconfirmation-highlighted@inkvell.com',
    confirmedAt: '2022-03-09T10:59:44.139Z',
    default: false,
  },
  {
    ...
    email: 'reconfirmation-nonsso@inkvell.com',
    confirmedAt: '2022-03-09T10:59:44.139Z',
    default: true,
  },
  {
    ...
    email: 'reconfirmation-sso@inkvell.com',
    confirmedAt: '2022-03-09T10:59:44.139Z',
...
export function emailLimitSetupMocks(fetchMock) {
  const userData = []
  for (let i = 0; i < 10; i++) {
    userData.push({ email: `example${i}@inkvell.com` })
  }
  defaultSetupMocks(fetchMock)
...
export function setReconfirmationMeta() {
  ...
  window.metaAttributesCache.set(
    ...
    'reconfirmation-highlighted@inkvell.com'
  )
  window.metaAttributesCache.set(
