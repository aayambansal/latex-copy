...
module.exports = {
  ...
  mongo: {
    ...
    url:
      ...
      `mongodb://${process.env.MONGO_HOST || '127.0.0.1'}/inkvell`,
  ...
  // Where your instance of InkVell/Server Pro can be found publicly. Used in emails
  ...
  allowPublicAccess: process.env.OVERLEAF_ALLOW_PUBLIC_ACCESS !== 'false',
  ...
  appName: process.env.APP_NAME || 'InkVell',
  ...
  nav: {
    title: process.env.APP_NAME || 'InkVell',

    hide_powered_by: true, // Always hide "Powered by Overleaf" for InkVell
    left_footer: [],
